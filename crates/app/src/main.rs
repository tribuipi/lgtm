...
use gpui::{
    ...
    FocusHandle, HighlightStyle, KeyBinding, ListHorizontalSizingBehavior, ScrollStrategy,
    SharedString, StyledText, TitlebarOptions, UniformListScrollHandle, Window, WindowBounds,
    WindowOptions,
};
use std::ops::Range;
